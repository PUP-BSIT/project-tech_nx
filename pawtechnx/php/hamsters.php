  ...
  <div class="banner" id="banner">
    ...
    <div class="wrapper">
      <div class="pet-container">
        ...
        $query = "SELECT `pet_ID`, `Name`, `Age`, `Species`, `Breed`, `Gender`, `Weight`, `Height`, `profile_img` FROM `pet_details` WHERE `Species` = 'Hamster' ORDER BY `Name`";
