...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin') {
    echo "Admin ID is not set or you do not have the required permissions. 
          Please log in.";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    $update_sql = "UPDATE admin SET Username=?, Firstname=?, Lastname=?, 
                          Password=? WHERE admin_ID=?";
    $update_stmt = mysqli_prepare($conn, $update_sql);
    mysqli_stmt_bind_param($update_stmt, "sssss", $username, $firstname, 
                           $lastname, $password, $admin_ID);
