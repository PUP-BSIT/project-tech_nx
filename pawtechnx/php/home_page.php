...
<body>
  ...
  <div class="wrapper">
    <div class="carousel-container">
      ...
      <ul class="carousel">
        <a href="../php/cats.php" title="Adopt a Cat">
          <li class="cat">
            <div class="pet-image">
        ...
        <a href="../php/hamsters.php" title="Adopt a Hamster">
          <li class="hamster">
            <div class="pet-image">
        ...
        <a href="../php/dogs.php" title="Adopt a Dog">
          <li class="dog">
            <div class="pet-image">
        ...
        <a href="../php/rabbits.php" title="Adopt a Rabbit">
          <li class="rabbit">
            <div class="pet-image">
