...
<body>
  ...
  <div class="wrapper">
    <div class="carousel-container">
      ...
      <ul class="carousel">
        <a href="../php/cat.php" title="Adopt a Cat">
          <li class="cat">
            <div class="pet-image">
        ...
        <a href="../php/hamster.php" title="Adopt a Hamster">
          <li class="hamster">
            <div class="pet-image">
        ...
        <a href="../php/dog.php" title="Adopt a Dog">
          <li class="dog">
            <div class="pet-image">
        ...
        <a href="../php/rabbit.php" title="Adopt a Rabbit">
          <li class="rabbit">
            <div class="pet-image">
