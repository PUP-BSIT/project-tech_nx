...
<body>
    ...
    <div class="header">
    <h1>Here are our Rabbbits!</h1>
    <p>They can't wait to meet you</p>
  </div>
    <div class="content">
        <h3>Meet our Lovely Rabbits!</h3>
    ...
    <div class="wrapper">
        ...
        $query = "SELECT `pet_ID`, `Name`, `Age`, `Species`, `Breed`, `Gender`, 
                ...
                FROM `pet_details` WHERE `Species` = 'Rabbit' 
        ...
        if ($query_run && mysqli_num_rows($query_run) > 0) {
            ...
            echo '<div class="adoption-message">All rabbits are adopted!</div>';
        }
