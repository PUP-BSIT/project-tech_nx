...
<body>
    ...
    <div class="header">
        <h1>Here are our Cats!</h1>
        <p>They can't wait to meet you</p>
    </div>
    <div class="content">
        <h3>Meet our Lovely Cats!</h3>
    ...
    <div class="wrapper">
        ...
        $query = "SELECT `pet_ID`, `Name`, `Age`, `Species`, `Breed`, `Gender`, `Weight`, `Height`, `profile_img`, `Availability`, `Description`
        ...
        if ($query_run && mysqli_num_rows($query_run) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($query_run)) {
                ...
                echo "<div class='pet' data-pet-id='" . htmlspecialchars($formatted_pet_ID) . "' onclick='showDetails(\"" . htmlspecialchars($formatted_pet_ID) . "\")'>";
            ...
            echo '<div class="adoption-message">All cats are adopted!</div>';
        }
