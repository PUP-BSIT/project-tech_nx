...
<body>
    ...
    <div class="header">
        <h1>Here are our Hamsters!</h1>
        <p>They can't wait to meet you</p>
    </div>
    <div class="content">
        <h3>Meet our Lovely Hamsters!</h3>
    ...
    <div class="wrapper">
        ...
        $query = "SELECT `pet_ID`, `Name`, `Age`, `Species`, `Breed`, `Gender`, 
            ...
            FROM `pet_details` WHERE `Species` = 'Hamster' 
        ...
        if ($query_run && mysqli_num_rows($query_run) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($query_run)) {
                ...
                $formatted_pet_ID = 'PT-' . str_pad($pet_ID_parts[1], 3, '0', STR_PAD_LEFT);

                echo "<div class='pet' data-pet-id='" 
                    . htmlspecialchars($formatted_pet_ID) . "' onclick='showDetails(\"" 
            ...
            echo '<div class="adoption-message">All hamsters are adopted!</div>';
        }
